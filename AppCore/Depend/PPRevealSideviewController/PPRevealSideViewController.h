...
typedef NSUInteger PPRevealSideType;

/*
 **侧滑类型
 */
enum {
     PPRevealSideOnBelow= 0,
     PPRevealSideOnObove= 1 << 1,
};
...
@interface PPRevealSideViewController : UIViewController <UIGestureRecognizerDelegate>
{
    ...
    BOOL                    _isOboveClose;
    PPRevealSideDirection   oboveTypeDirection;
    PPRevealSideType        type;
}
...
@property (nonatomic, assign) PPRevealSideType        type;
/**
